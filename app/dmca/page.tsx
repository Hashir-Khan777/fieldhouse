        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                Green Dragon Den respects the intellectual property rights of
                others and expects our users to do the same. We respond to
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                ...
                copyright, please provide our designated agent with the
            ...
            <CardContent className="text-cream space-y-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>
                  ...
                  faith belief the material was removed in error
                </li>
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                ...
                repeat infringers of copyrighted material.
              </p>
            </CardContent>
          </Card>
