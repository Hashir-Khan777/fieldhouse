    ...
    <div className="container px-4 py-6 md:px-6 space-y-8">
      ...
      <section className="py-12 md:py-24 text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Share your sports content with fans around the world on Green Dragon
          Den
        </p>
      ...
      <section id="learn-more" className="py-12 space-y-8">
        <div className="text-center space-y-4 mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-fhsb-cream">
            Why Choose Green Dragon Den?
          </h2>
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Our platform is designed specifically for sports content creators
            and fans
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Our platform is optimized for sports with ultra-low latency
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2">
                  <Check className="h-5 w-5 text-fhsb-green" />
                  <span className="text-fhsb-cream">
          ...
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Connect with a passionate community of sports fans and creators
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
          ...
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Detailed insights to help you grow your audience and content
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
          ...
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Broadcast your content to sports fans worldwide
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
          ...
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Protect your content with advanced security features
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
          ...
          <Card className="bg-card border-fhsb-green/20">
            <CardHeader>
              ...
              <CardDescription>
                Multiple ways to earn revenue from your content
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
      ...
      <section className="py-12 space-y-8">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Getting started as a creator is simple
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-bold text-fhsb-cream">
              Create an Account
            </h3>
            <p className="text-muted-foreground">
              Sign up for a free account and complete your creator profile
            </p>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Configure your streaming settings and customize your channel
            </p>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Start streaming and connect with your audience
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 text-center space-y-6">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Join Green Dragon Den today and share your content with fans around
          the world
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
          <Link href="/register">
