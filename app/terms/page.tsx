        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                By accessing and using Green Dragon Den, you accept and agree to
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                ...
                materials on Green Dragon Den for personal, non-commercial
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                Users are responsible for all content they upload, stream, or
                share on our platform. Content must comply with our Community
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                In no event shall Green Dragon Den or its suppliers be liable
          ...
          <Card className="bg-gray-900 border-gray-800 mb-6">
            ...
            <CardContent className="text-cream space-y-4">
              <p>
                ...
                contact us at legal@fieldhousestadium.com
              </p>
