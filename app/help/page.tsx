    ...
    <div className="container px-4 py-6 md:px-6 space-y-8">
      <div className="text-center space-y-4 max-w-3xl mx-auto py-8">
        ...
        <p className="text-xl text-muted-foreground">
          Find answers to your questions about Green Dragon Den
        </p>
      ...
      <div className="py-8">
        <h2 className="text-2xl font-bold text-fhsb-cream mb-6">
          Frequently Asked Questions
        </h2>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-fhsb-green/20">
            ...
            <AccordionContent className="text-muted-foreground">
              Green Dragon Den is a live streaming platform specifically
              designed for sports content. It allows creators to stream live
              sports events, analysis, coaching sessions, and more to a global
          ...
          <AccordionItem value="item-2" className="border-fhsb-green/20">
            ...
            <AccordionContent className="text-muted-foreground">
              To start streaming, you need to create an account, set up your
              creator profile, and configure your streaming software. Visit our
              Creator Resources section for detailed guides on getting started
              with streaming.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3" className="border-fhsb-green/20">
            ...
            <AccordionContent className="text-muted-foreground">
              Yes, Green Dragon Den is free to use for viewers. Creators have
              access to basic streaming features for free, with premium features
              available through our subscription plans.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4" className="border-fhsb-green/20">
            ...
            <AccordionContent className="text-muted-foreground">
              Creators can monetize their content through channel subscriptions,
              viewer donations, ad revenue sharing, and sponsored content. You
              need to meet certain eligibility requirements to access these
          ...
          <AccordionItem value="item-5" className="border-fhsb-green/20">
            ...
            <AccordionContent className="text-muted-foreground">
              Green Dragon Den welcomes sports-related content including live
              events, analysis, coaching, fitness, and educational content. All
              content must comply with our Community Guidelines and Terms of
              Service.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
